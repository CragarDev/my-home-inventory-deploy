...
const InventoryForm = props => {
  ...
  const handleFile = event => {
    console.log(':::: Entered handleFile ::::')
    console.log('=== handleFile === File', event.target.files[0])
  ...
  const handleClick = e => {
    ...
    console.log('Input Contains File', inputContainsFile)
    console.log('inventoryImage: ', inventoryImage)
    if (inputContainsFile) {
      setCurrentlyUploading(true)
      submitNewInventory(e)
    }
  }

  // for handling form submission
  const submitNewInventory = event => {
    console.log(':::: Entered submitNewInventory ::::')
    ...
    console.log('user_id', loggedInUserId)
    ...
    formData.append('inventoryImage', file, file.name)
    console.log('inventoryImage', inventoryImage)
    console.log('inventoryImage-file', file)
    console.log('inventoryImage-file.name', file.name)
    ...
    axios
      ...
      .then(({ data }) => {
        console.log('INVENTORY FORM RESPONSE', data)
        setImageId(data)
        ...
        if (data.error) {
          console.log('INVENTORY FORM ERRORS', data.error)
